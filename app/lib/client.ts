...
export function Environment(name: string): BaseURL {
    return `https://${name}-aiccounting-pi22.encr.app`
}
...
/**
 * Client is an API client for the aiccounting-pi22 Encore application.
 */
export default class Client {
    public readonly fortnox: fortnox.ServiceClient
    public readonly klarna: klarna.ServiceClient
    public readonly klarna_fortnox: klarna_fortnox.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.fortnox = new fortnox.ServiceClient(base)
        this.klarna = new klarna.ServiceClient(base)
        this.klarna_fortnox = new klarna_fortnox.ServiceClient(base)
...
export namespace fortnox {
    ...
    export class ServiceClient {
        ...
        public async authenticate(): Promise<void> {
            await this.baseClient.callTypedAPI("POST", `/fortnox/authenticate`)
        }

        public async callback(method: "GET", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/fortnox/callback`, body, options)
        }
    }
}
...
export namespace klarna {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.getPayoutTransactions = this.getPayoutTransactions.bind(this)
        ...
        public async getPayoutTransactions(paymentReference: string): Promise<endpoints.Response> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/klarna/payouts/${encodeURIComponent(paymentReference)}/transactions`)
            return await resp.json() as endpoints.Response
        }

        public async getPayouts(params: endpoints.Params): Promise<endpoints.Payouts> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/klarna/payouts`, undefined, {query})
            return await resp.json() as endpoints.Payouts
        }
    }
}
...
export namespace tenants {
    ...
    export class ServiceClient {
        ...
        public async connectFortnox(id: string): Promise<void> {
            await this.baseClient.callTypedAPI("POST", `/tenants/${encodeURIComponent(id)}/fortnox/connect`)
        }
        ...
        public async create(): Promise<void> {
            await this.baseClient.callTypedAPI("POST", `/tenants`)
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "aiccounting-pi22-Generated-TS-Client (Encore/v1.48.12)";
        }
