...
export namespace iam {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.bankIdStart = this.bankIdStart.bind(this)
         ...
         * Start BankID login
         */
        public async bankIdStart(params: endpoints.StartBankIdRequest): Promise<void> {
            await this.baseClient.callTypedAPI("POST", `/auth/bankid/start`, JSON.stringify(params))
        }

        /**
         * Poll BankID status
         */
        public async bankIdStatus(params: endpoints.PollBankIdRequest): Promise<void> {
            await this.baseClient.callTypedAPI("POST", `/auth/bankid/status`, JSON.stringify(params))
        }
...
export namespace klarna {
    ...
    export class ServiceClient {
        ...
        public async getPayouts(params: endpoints.GetPayoutsParams): Promise<endpoints.GetPayoutsResponse> {
            ...
            return await resp.json() as endpoints.GetPayoutsResponse
        }
    }
}
